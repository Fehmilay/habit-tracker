...
> **Status: umgesetzt.** Habits werden auf der linken Swipe-Seite bewertet, der Tag wird
> genau einmal abgeschlossen und die persistierte Auswirkung anschließend animiert.
...
- [x] Mobile Habit-Seite mit allen vier Status je Aufgabe
- [x] Unbewertete Habits werden nie automatisch als Fehler gespeichert
- [x] Doppelter Tagesabschluss unmöglich
- [x] Animation überspringbar
- [x] Ereignisse, Flugreaktion, neuer Kurs und langfristige Kilometer-/Zielwirkung
