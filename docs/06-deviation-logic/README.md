...
> **Status: umgesetzt.** Die Logik ist an Habit-Check-in, Persistenz, 3D-Flugzeug und
> Zukunftsprojektion angebunden.
...
- [x] Funktion implementiert, deterministisch, vollständig getestet
- [x] An das 3D-Flugzeug angebunden (Ergebnis setzt den Sollkurs)
